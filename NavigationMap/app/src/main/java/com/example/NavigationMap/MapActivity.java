...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnPolylineClickListener {
    private String ApiKey = "AIzaSyAV272XrMF1s6-vhtVkHhIU7r2v5hMYEJ4";
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Toast.makeText(this, "Map has successfully loaded", Toast.LENGTH_SHORT).show();
        Log.d(TAG, "onMapReady: Map has successfully loaded");
        ...
        if (mLocationPermissionsGranted) {
            ...
            RXXXMap.setMyLocationEnabled(true);
            RXXXMap.getUiSettings().setMyLocationButtonEnabled(true);
            RXXXMap.setPadding(0, 200, 0, 0);
        ...
        RXXXMap.setOnPolylineClickListener(this);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                Marker marker = RXXXMap.addMarker(new MarkerOptions()
                        .position(latLng)
                        .title(place.getName()));
    ...
    private void moveCamera(LatLng latLng, float zoom, String title) {
        ...
        RXXXMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, zoom));
        if (!title.equals("My Location")) {
            MarkerOptions options = new MarkerOptions()
                    .position(latLng)
                    .title(title);
            RXXXMap.addMarker(options);
        }
    }
...
private String getUrl(double latitude, double longitude, String nearbyPlace)
{
    ...
    longitude=lastlocation.getLongitude();
     ...
     googlePlaceUrl.append("&key="+"AIzaSyAV272XrMF1s6-vhtVkHhIU7r2v5hMYEJ4");
...
//                        Log.d(TAG, "run: latlng: " + latLng.toString());
                    ...
                    Polyline polyline = RXXXMap.addPolyline(new PolylineOptions().addAll(newDecodedPath));
        ...
        for (int i = 0; i < polylineDataList.size(); i++) {
            ...
            if(polyline.getId().equals( polylineDataList.get(i).getPolyline().getId())){
                ...
                Marker marker = RXXXMap.addMarker(new MarkerOptions()
                        .position(endLocatin)
                        .title("Main Trip: " + (i+1))
                        .snippet("Distance: " + polylineDataList.get(i).getLeg().duration)
                );
